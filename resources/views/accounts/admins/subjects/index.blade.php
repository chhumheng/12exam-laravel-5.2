    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Subject Information!</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            </div>
        ...
        <div class="text-center panel-body" >
            ...
            <div class="row">
                <div class="text-right col-md-12">
                    {!! Html::decode(link_to( '/account/subject/create','<span class="glyphicon glyphicon-plus"></span> '.'Add New School', $attributes = array('class' => 'btn btn-sm btn-info','title' => 'Add New Subject' ))) !!}
                </div>
            </div>
